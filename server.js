...
const { obtenerProductoPorId, obtenerProductos, modificarProducto, borrarProductoPorId, agregarProducto } = require('./resolvers');
...
const graphMiddleware = graphqlHTTP({
  ...
  rootValue: {
    ...
    borrarProductoPorId: borrarProductoPorId,
